...
export class RefundService {
     ...
     */
    async initiateRefund(orderId: string, userId: string, dto?: RequestRefundDto) {
        ...
        if (order.refund_status === RefundStatus.INITIATED ||
        ...
        const isEligible = order.current_status === 'CANCELLED' ||
