...
import { Occasion, BodyShape, SkinTone, Size } from '../enums/recommendation.enum';
...
export class GetRecommendationsDto {
    ...
    @ApiProperty({
        description: 'User body shape (optional, will use Aura data if not provided)',
        enum: BodyShape,
        required: false,
    })
    @IsOptional()
    ...
    @ApiProperty({
        description: 'User skin tone (optional, will use Aura data if not provided)',
        enum: SkinTone,
        required: false,
    })
    @IsOptional()
