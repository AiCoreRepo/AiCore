...
const LuxeSidebar: React.FC<{
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full bg-stone-900 border-r border-stone-800 flex flex-col shadow-2xl z-50 transition-all duration-300 ease-in-out ${isMobile
          ? (isCollapsed ? "-translate-x-full w-[300px]" : "translate-x-0 w-[300px]")
