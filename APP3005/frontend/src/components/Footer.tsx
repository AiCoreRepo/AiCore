            ...
            <div className="container mx-auto px-6 md:px-12 max-w-7xl py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="text-center md:text-left">
                        <a href="/" className="font-serif text-xl font-semibold inline-block mb-2">
                            <span className="text-[#D4AF37]">Ai</span>Vestire
                        </a>
                    ...
                    <div className="flex gap-3">
                        {socialLinks.map((social) => (
                            <a
                                key={social.name}
                                href={social.href}
                                className="p-2 rounded-full border border-ivory/20 hover:border-[#D4AF37] hover:bg-[#D4AF37]/10 transition-colors"
                ...
                <div className="text-center mt-6 pt-6 border-t border-ivory/10">
                    <p className="text-sm text-ivory/40">
                        © 2026 AiVestire. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
