...
// Modal with chip selection for return reasons
// ============================================
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    ${selectedReason === reason.value
                                            ? 'border-blue-500 bg-blue-50 chip-selected'
                  ...
                  `}
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm text-blue-800">
                                ...
                                <ol className="list-decimal list-inside space-y-1 text-xs">
                                    <li>Your return request will be reviewed within 24 hours</li>
                                    <li>Once approved, we'll schedule a pickup</li>
                                    <li>After quality check, refund will be initiated</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            ...
                            className="flex-1 px-6 py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-all disabled:opacity-50 button-primary relative overflow-hidden"
                        >
                            {isSubmitting ? (
