...
import {
    ...
    FileQuestion, MoreHorizontal, ArrowRight, Check, Repeat
} from 'lucide-react';
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                        ...
                        <div className="mb-10">
                            <div className="w-14 h-14 bg-[#2C2416] rounded-2xl flex items-center justify-center mb-6 shadow-inner shadow-[#C9A55C]/20 border border-[#C9A55C]/30">
                                <Repeat className="w-7 h-7 text-[#C9A55C]" />
                            </div>
                            <h2 className="text-4xl font-serif mb-2 tracking-wide font-medium text-white">Replace Item</h2>
                        ...
                        <div className="mt-auto space-y-8">
                            <h4 className="text-white/60 text-xs tracking-widest uppercase font-semibold mb-6">Replacement Pipeline</h4>
                            ...
                            <div className="flex gap-4 items-start group">
                                ...
                                <div>
                                    <h5 className="text-white font-medium mb-1.5 text-base">Issue Details</h5>
                                    <p className="text-[#999999] text-sm leading-relaxed">Let us know what went wrong so we prepare the perfect replacement.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 items-start group">
                                ...
                                <div>
                                    <h5 className="text-white font-medium mb-1.5 text-base">Exchange Pickup</h5>
                                    <p className="text-[#999999] text-sm leading-relaxed">We will coordinate a convenient time to pick up the original item.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 items-start group">
                                ...
                                <div>
                                    <h5 className="text-white font-medium mb-1.5 text-base">Fresh Dispatch</h5>
                                    <p className="text-[#999999] text-sm leading-relaxed">Immediately after pickup, your fresh replacement is dispatched.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col relative bg-[#FDFBF7]">
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-[#E0E0D8] md:border-none md:absolute md:top-0 md:right-0 md:w-full md:justify-end md:p-6 md:z-20">
                        <div className="md:hidden">
                            <h2 className="text-xl font-bold text-[#2C2416]">Replace Item</h2>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 md:px-10 md:pt-16 md:pb-10 scrollbar-thin scrollbar-thumb-[#E0E0D8]">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="mb-6 hidden md:block">
                                <h3 className="text-2xl font-bold text-[#2C2416]">Replacement Details</h3>
                            ...
                            <div className="mb-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Tell us what went wrong so we can prepare your replacement correctly..."
                                    rows={3}
