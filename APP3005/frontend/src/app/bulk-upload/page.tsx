    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6 gap-6">
      ...
      <div>
        ...
        <p
          ...
          style={{ color: 'rgba(44,36,22,0.55)', lineHeight: 1.7 }}
        >
          Product uploads now use a guided flow -
          <strong> Product → Pattern → Color Variant</strong>.
          Go to your dashboard and click <strong>"Upload New Outfit"</strong> to
          get started.
        </p>
      </div>
